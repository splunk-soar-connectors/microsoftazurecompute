...
MS_AZURE_STATE_FILE_CORRUPT_ERR = "Error occurred while loading the state file due to its unexpected format. Resetting the state file with the default format. \
Please try again."
...
MS_AZURE_INVALID_TOKEN_MSG = ['token is invalid', 'Access token has expired', 'ExpiredAuthenticationToken', 'AuthenticationFailed']
MS_AZURE_TIMEOUT = 30
